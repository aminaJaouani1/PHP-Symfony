 ...
 */
final class Version20250603150152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comment ALTER photo_filename DROP NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE comment ALTER photo_filename SET NOT NULL
        SQL);
    }
}
